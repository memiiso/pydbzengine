...
class IcebergCatalogContainer(DockerContainer):
    ...
    def __init__(self):
        ...
        # self.with_env("AWS_ACCESS_KEY_ID", MinioContainer.AWS_ACCESS_KEY_ID)
        # self.with_env("AWS_SECRET_ACCESS_KEY", MinioContainer.AWS_SECRET_ACCESS_KEY)
        # self.with_env("AWS_REGION", MinioContainer.AWS_REGION)
        # self.with_env("CATALOG_WAREHOUSE", f"s3://{MinioContainer.S3_WAREHOUSE_BUCKET}/")
